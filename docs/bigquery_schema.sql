...
CREATE TABLE IF NOT EXISTS tennis_raw.fact_matches (
    ...
    winner_seed INT64 OPTIONS(description="winner's tournament seed"),
    winner_entry STRING OPTIONS(description="winner's entry type: WildCard, Qualifier, LL, etc."),
    winner_rank INT64 OPTIONS(description="winner's ATP ranking at time of match"),
    winner_rank_points INT64 OPTIONS(description="winner's ranking points"),
    winner_age INT64 OPTIONS(description="winner's age at time of match"),
    winner_ht INT64 OPTIONS(description="winner's height in cm"),
    ...
    loser_seed INT64 OPTIONS(description="oser's tournament seed"),
    loser_entry STRING OPTIONS(description="loser's entry type"),
    loser_rank INT64 OPTIONS(description="loser's ATP ranking at time of match"),
    loser_rank_points INT64 OPTIONS(description="loser's ranking points"),
    loser_age FLOAT64 OPTIONS(description="loser's age at time of match"),
    loser_ht INT64 OPTIONS(description="loser's height in cm"),
    loser_hand STRING OPTIONS(description="loser's handedness"),
    loser_ioc STRING OPTIONS(description="loser's country code"),
